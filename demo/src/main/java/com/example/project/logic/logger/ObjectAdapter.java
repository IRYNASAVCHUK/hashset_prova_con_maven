...
public class ObjectAdapter extends TypeAdapter<Object> {
    private int level;
    private boolean allFields; // devo mettere dentro confid allField = false , di default, -> uso: getDeclaredFields()
    // true -> 
    ...
    public void write(JsonWriter out, Object value) throws IOException {
        ...
        insideObject = true;
        try {
            Field[] fields = value.getClass().getDeclaredFields();// -> allfieflds è di defoult false
            // qualdo imposto allFields == TRUE -> reflection: CLASS.java...->  Class<T> GETSUPERClass()!!!!
            ...
            //FARE IL CLASSE LIST ARRAY piu semplice
