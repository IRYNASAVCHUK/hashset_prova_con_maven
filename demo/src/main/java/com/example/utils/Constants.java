...
public class Constants {
        ...
        public static final String LOG_FILE = (ConfigLoader.getConfigStringValue("logFile") != null)
                        ...
                        : "logFile.json";
        public static final int LEVEL = (ConfigLoader.getConfigIntValue("objectLevel") == null
                        || ConfigLoader.getConfigIntValue("objectLevel") <= 0)
                                        ? 0
                                        : ConfigLoader.getConfigIntValue("objectLevel");
}
